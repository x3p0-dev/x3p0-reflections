...
register_block_style( 'core/image', [
	'name' => 'border',
	'label' => __( 'Border', 'x3p0-profile' )
] );

register_block_style( 'core/image', [
	'name' => 'cover-overlay',
	'label' => __( 'Cover Overlay', 'x3p0-profile' )
] );

register_block_style( 'core/image', [
	'name' => 'frame',
	'label' => __( 'Frame', 'x3p0-profile' )
] );

register_block_style( 'core/image', [
	'name' => 'frame-light',
	'label' => __( 'Frame: Light', 'x3p0-profile' )
] );
...
register_block_style( 'core/image', [
	...
	'label' => __( 'Hand-Drawn: Caption Left', 'x3p0-profile' )
] );

register_block_style( 'core/image', [
	'name' => 'hand-drawn-caption-right',
	'label' => __( 'Hand-Drawn: Caption Right', 'x3p0-profile' )
] );
