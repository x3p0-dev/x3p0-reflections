<!-- wp:cover {"url":"https://pd.w.org/2021/12/22261bc467642e4a9.92448476-1536x2048.jpg","hasParallax":true,"dimRatio":50,"overlayColor":"primary-900","isDark":false,"align":"full","style":{"spacing":{"padding":{"top":"2rem","right":"2rem","bottom":"2rem","left":"2rem"}}}} -->
<div class="wp-block-cover alignfull is-light has-parallax" style="padding-top:2rem;padding-right:2rem;padding-bottom:2rem;padding-left:2rem;background-image:url(https://pd.w.org/2021/12/22261bc467642e4a9.92448476-1536x2048.jpg)"><span aria-hidden="true" class="has-primary-900-background-color wp-block-cover__gradient-background has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"border":{"width":"2px","style":"solid"}},"borderColor":"primary-900"} -->
...
<!-- wp:site-title {"style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"typography":{"textTransform":"uppercase"}},"textColor":"white","fontSize":"2xl"} /--></div>
<!-- /wp:group -->
...
<!-- wp:social-links {"size":"has-small-icon-size","className":"is-style-pill-shape","layout":{"type":"flex","justifyContent":"center"}} -->
<ul class="wp-block-social-links has-small-icon-size is-style-pill-shape"><!-- wp:social-link {"url":"#","service":"twitter"} /-->
