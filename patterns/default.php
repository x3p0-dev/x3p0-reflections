<!-- wp:cover {"url":"<?= esc_url( get_theme_file_uri( 'public/img/22261bc467642e4a9.92448476-1536x2048.jpg' ) ) ?>","hasParallax":true,"dimRatio":50,"overlayColor":"primary-900","isDark":false,"align":"full","style":{"spacing":{"padding":{"top":"2rem","right":"2rem","bottom":"2rem","left":"2rem"}}}} -->
<div class="wp-block-cover alignfull is-light has-parallax" style="padding-top:2rem;padding-right:2rem;padding-bottom:2rem;padding-left:2rem;background-image:url(<?= esc_url( get_theme_file_uri( 'public/img/22261bc467642e4a9.92448476-1536x2048.jpg' ) ) ?>)"><span aria-hidden="true" class="has-primary-900-background-color wp-block-cover__gradient-background has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"border":{"width":"2px","style":"solid"}},"borderColor":"primary-900"} -->
...
<!-- wp:social-links {"size":"has-normal-icon-size","className":"is-style-pill-shape","layout":{"type":"flex","justifyContent":"center"},"style":{"spacing":{}}} -->
<ul class="wp-block-social-links has-normal-icon-size is-style-pill-shape"><!-- wp:social-link {"url":"#","service":"twitter"} /-->
