<!-- wp:cover {"dimRatio":50,"overlayColor":"neutral-300","minHeight":100,"minHeightUnit":"vh","isDark":false,"align":"full"} -->
<div class="wp-block-cover alignfull is-light" style="min-height:100vh"><span aria-hidden="true" class="has-neutral-300-background-color wp-block-cover__gradient-background has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:spacer {"height":"2rem"} -->
...
<footer class="wp-block-group"><!-- wp:social-links {"iconColor":"neutral-600","iconColorValue":"#718096","iconBackgroundColor":"transparent","iconBackgroundColorValue":"transparent","size":"has-normal-icon-size","className":"is-style-rectangle-outline","layout":{"type":"flex","justifyContent":"left","orientation":"horizontal"}} -->
<ul class="wp-block-social-links has-normal-icon-size has-icon-color has-icon-background-color is-style-rectangle-outline"><!-- wp:social-link {"url":"#","service":"linkedin"} /-->
